...
int main(){
    ...
    BitPlaneEncoderRD my_bpe;
    BitPlaneDecoderRD my_bpd;

    my_bpe.load_code_block(cb);
    my_bpe.reconstruct_wavelet_coeffs();
    my_bpe.print_wavelets();
    my_bpe.init_implied_coeffs();
    my_bpe.reset_bp_encoder();
    my_bpe.encode_code_block();
    my_bpe.print_implied();
    my_bpe.make_coded_block();
    coded_block cb_coded;
    cb_coded = my_bpe.get_coded_block(); 

    my_bpe.print_coded_block_stats();
